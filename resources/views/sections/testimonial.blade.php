    ...
    <div class="container">
        <div class="row justify-content-center mb-5 mb-lg-7">
            <div class="col-12 col-md-8 text-center">
                <h1 class="h1 font-weight-bolder mb-4" style="color:#F4E3BB">Our satisfied customers</h1>
                <p class="lead text-yellow" style="color:#F4E3BB">See what people say about us</p>
            </div>
        </div>
