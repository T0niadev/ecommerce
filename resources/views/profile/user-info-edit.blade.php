...
@section('content')
  ...
  <!-- Hero -->
  <section class="bg-soft text-dark pt-7 pb-4">
    <div class="container">
        ...
        <div class="col-md-8">
            <div class="card border-light bg-light">
                ...
                <div class="card-body">
                    ...
                    <hr class="my-4" />
                    <!-- Address -->
                    <h6 class="heading-small text-muted mb-4">Upload Profile Picture</h6>
                    <div class="pl-lg-4">
                      <div class="row">
                        <div class="col-md-12">

                            <form method="post" action="{{url('profile.avatar_remove')}}">
                              @csrf
                                @if(auth()->user()->avatar!='users/default.png')
                                  <img src="{{(auth()->user()->avatar)}}">
                                  <div class="row my-2">
                                    <div class="col-6">
                                      <button type="submit" class="btn btn-sm btn-danger">Remove Profile Picture</button>
                                    </div>
                                  </div>
                                @else
                            ...
                            <form method="post" action="{{url('profile.avatar')}}" enctype="multipart/form-data">
                              ...
                              <div class="row">
                                <div class="col-lg-6">
                                  <div class="form-group">
                                    <button type="submit" class="btn btn-dark">Upload Profile Picture</button>
                                  </div>
                                </div>
                              </div>
                            </form>
